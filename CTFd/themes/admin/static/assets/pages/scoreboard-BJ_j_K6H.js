import{$ as d,C as l,A as f}from"./main-sbGV3kXM.js";import{l as p}from"../index-TjCxX7sJ.js";const u={users:(e,a)=>l.api.patch_user_public({userId:e},a),teams:(e,a)=>l.api.patch_team_public({teamId:e},a)},b=p("https://ctfd-ies-rafael-alberti.onrender.com");b.on("connect",function(){console.log("Connected to the server")});function h(){const e=d(this),a=e.data("account-id"),i=e.data("state");let t;i==="visible"?t=!0:i==="hidden"&&(t=!1);const n={hidden:t};u[l.config.userMode](a,n).then(s=>{s.success&&(t?(e.data("state","hidden"),e.addClass("btn-danger").removeClass("btn-success"),e.text("Hidden")):(e.data("state","visible"),e.addClass("btn-success").removeClass("btn-danger"),e.text("Visible")))})}function m(e,a){const i={hidden:a==="hidden"},t=[];for(let n of e.accounts)t.push(u[l.config.userMode](n,i));for(let n of e.users)t.push(u.users(n,i));Promise.all(t).then(n=>{window.location.reload()})}function g(e){let a=d(".tab-pane.active input[data-account-id]:checked").map(function(){return d(this).data("account-id")}),i=d(".tab-pane.active input[data-user-id]:checked").map(function(){return d(this).data("user-id")}),t={accounts:a,users:i};f({title:"Toggle Visibility",body:d(`
    ...
    `}),d("#standings-table-body").html(n),t==="teams"&&i){let s="";i.forEach((o,c)=>{const r=v("admin.users_detail",{user_id:o.user_id});s+=`
      ...
      `}),d("#user-standings-table-body").html(s)}}b.on("scoreboard_update",function(e){_(e.data)});d(document).ready(function(){b.emit("request_initial_data")});
